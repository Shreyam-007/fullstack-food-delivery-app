    ...
    <motion.div className="w-full flex items-start justify-start flex-col">
      <div className="w-full flex items-center justify-between">
        <div className="flex flex-col items-start justify-start gap-1">
          <p className="text-2xl font-bold text-headingColor">Our Hot Dishes <img src="https://img.icons8.com/emoji/48/000000/fire.png" className="w-10 h-10 inline" /></p>
...
export const FilterCard = ({ data, index, category, setCategory }) => {
  return (
    <motion.div
      ...
      } hover: bg-primary shadow-md flex flex-col items-center justify-center gap-4 `}
    >
      <div
